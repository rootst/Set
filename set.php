...
function change(){
        ...
        echo color("green","Kode OTP Udah kirim")."\n";
        otp:
        echo color("red","SMS ATAU OTP : ");
        ...
        echo color("nevy","\n▬▬▬▬▬▬▬▬▬▬▬▬BISILLAH BIAR ALLHAMDULILAH▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","=>Claim voc EATLAH");
        echo "\n".color("yellow","Tunggu Sabar");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        echo "\n".color("red","Message: ".$message);
	      gocar:
        echo "\n".color("nevy","=>Claim voc GOFOOD PERTAMA");
        echo "\n".color("yellow","Tunggu Sabar");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        ...
        echo "\n".color("red","Message: ".$message);
        gofood:
        echo "\n".color("nevy","Claim voc GOFOOD KE DUA");
        echo "\n".color("yellow","Tunggu Sabar");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
